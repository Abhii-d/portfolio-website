                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4">
                        <div className="mb-3 lg:mb-0">
                          ...
                          <p className="text-primary-600 font-semibold text-base md:text-lg mb-2">
                            {experience.company}
                          </p>
                          {experience.isCurrentRole && (
                            <span className="inline-flex items-center px-2 py-1 md:px-3 md:py-1 bg-green-100 text-green-700 rounded-full text-xs md:text-sm font-medium">
                              Current Role
                            </span>
                          )}
                        </div>
                        <div className="lg:text-right">
                          ...
                          <p className="text-xs md:text-sm text-slate-400">{experience.location}</p>
                        </div>
                      </div>
                      
                      <p className="text-slate-600 mb-4 md:mb-6 text-sm md:text-base lg:text-lg leading-relaxed">
                          ...
                          <ul className="space-y-2">
                            {experience.achievements.map((achievement, index) => (
                              <li key={index} className="flex items-start space-x-2">
                                ...
                                <span className="text-slate-600 text-sm md:text-base">{achievement}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1.5 md:gap-2">
                          {experience.technologies.map((tech) => (
                            <span
                              key={tech}
                              className="px-2 py-1 md:px-3 md:py-1 bg-primary-100 text-primary-700 rounded-full text-xs md:text-sm font-medium hover:bg-primary-200 transition-colors"
                            >
                              {tech}
                            </span>
                          ))}
