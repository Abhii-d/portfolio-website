              ...
              <div className="card p-8 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-grow">
                    ...
                    {/* Achievements */}
                    {experience.achievements.length > 0 && <div>
                    ...
                    <h4 className="font-semibold text-slate-900 mb-3">
                      ...
                      {experience.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-3 py-1 bg-primary-100 text-primary-700 rounded-full text-sm font-medium hover:bg-primary-200 transition-colors mr-2"
                        >
                          {tech }
                        </span>
                      ))}
